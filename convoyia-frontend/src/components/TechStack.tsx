...
const stacks = [
  {
    ...
    items: [
      ...
      { name: "Apache Kafka",     desc: "Inter-agent event streaming"                },
    ...
    <section id="tech" className="py-24 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center mb-16">
          <p className="section-label"><Server size={14} /> Tech Stack</p>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {stacks.map((s) => (
            <div key={s.category} className="card-glass p-6">
              <h3 className="font-bold text-xs uppercase tracking-widest text-white/40 mb-5">{s.category}</h3>
