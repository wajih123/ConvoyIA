...
export default function Hero() {
  return (
    <section className="relative pt-32 pb-24 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[600px] bg-brand-600/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mt-10 text-sm text-white/40">
          Powering{" "}
          <span className="text-white/70 font-semibold">Goweyy</span> — live in
          production in Nice, France · Expanding to 12 markets
        </p>
        ...
        <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
          {[
            ...
            { value: "<72ms", label: "Avg. API latency" },
